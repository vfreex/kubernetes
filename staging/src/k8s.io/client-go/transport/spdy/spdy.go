...
func NewDialer(upgrader Upgrader, client *http.Client, method string, url *url.URL, newStreamHandler httpstream.NewStreamHandler) httpstream.Dialer {
	return &dialer{
		client:   client,
		upgrader: upgrader,
		method:   method,
...
func (d *dialer) Dial(protocols ...string) (httpstream.Connection, string, error) {
	...
	return Negotiate(d.upgrader, d.client, req, d.newStreamHandler, protocols...)
}
